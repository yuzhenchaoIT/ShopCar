...
public class MyView_ extends LinearLayout {
    ...
    public MyView_(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyView_(Context context, AttributeSet attrs, int defStyleAttr) {
